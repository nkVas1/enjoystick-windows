...
// =============================================================================
// EnjoyStick Design System  —  "Futurist Glamour"
//
// Philosophy:
//   Minimal surfaces, maximal depth.
//   Every element is sculpted, not flat.
//   Gold is used sparingly — never decorative, always structural.
//   Motion is physical: spring curves, bounce, settle.
//   Inspired by: Apple Human Interface, high-end audio hardware UI,
//                dark-matter luxury product aesthetics.
//
// Palette:
//   Surface tier :
//     SurfaceSunken   #060609   rgb(  6,  6,  9)   deep well / input bg
//     SurfaceBase     #0C0C12   rgb( 12, 12, 18)   main panel
//     SurfaceRaised   #14141E   rgb( 20, 20, 30)   cards / floating elements
...
//
//   Utility:
//     Pure white      #FFFFFF                      top specular gleam
//     Transparent     alpha 0
// =============================================================================
...
struct Tok {
    ...
    static D2D1_COLOR_F GoldGlow  (float a = 0.18f) noexcept {
        return D2D1::ColorF(0.910f, 0.788f, 0.478f, a); } // wide halo
    ...
    static D2D1_COLOR_F Scrim      (float a = 0.55f) noexcept {
        return D2D1::ColorF(0.020f, 0.018f, 0.032f, a); }

    // =========================================================================
    // Legacy aliases  (deprecated — kept for build compatibility)
    // Migrate call-sites to the named tokens above.
    // =========================================================================
